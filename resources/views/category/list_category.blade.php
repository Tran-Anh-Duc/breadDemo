                            ...
                            @foreach($category as $key => $value)
                                <tr>
                                    ...
                                    <td style="text-align: center;padding-top: 13px">
                                        <label for="" class="switch" data-id="{{$value['id']}}" data-url="{{route('category.update_status', ['id' => $value['id']])}}">
                                    ...
                                    <td><a href="{{url('category/detail_category/'.$value['id'])}}" class="btn btn-warning">Chi tiết</a></td>
                                </tr>
                            @endforeach
                        @else
                            <div>
