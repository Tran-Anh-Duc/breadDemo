     ...
     <div class="container-sm">
        <div class="card">
            <div class="card-body">
                <div class="tables ">
                    <div style="right: 100%">
                        <a href="{{route('product_store.view_product_store')}}" class="btn btn-success " style="margin-left: 79%">Thêm mới sản phẩm vào kho</a>
                    </div>
                    <table class="table">
                        <thead>
                        <tr>
                            ...
                            <th scope="col" style="text-align: center">Tên kho hàng</th>
