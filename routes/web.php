...
Route::prefix('bread')->group(function () {
    ...
    Route::get('/updateCardTable/{idTable}', [TemplateController::class, 'updateCardTable'])->name('bread.updateCardTable');
...
Route::prefix('category')->group(function () {
    ...
    Route::post('/uploadImage', [CategoryController::class, 'uploadImage'])->name('category.uploadImage');
});
